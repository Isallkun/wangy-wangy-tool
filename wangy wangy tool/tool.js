var templateSelect = 1;
var btnList = document.getElementsByClassName('btn-type');
...
function template1(){
    const nama = document.getElementById("name").value ;
    btnList[templateSelect - 1].classList.remove('type-selected');
    btnList[0].classList.add('type-selected');
    templateSelect = 1;
...
function template2() {
    const nama = document.getElementById("name").value ;
    btnList[templateSelect - 1].classList.remove('type-selected');
    btnList[1].classList.add('type-selected');
    templateSelect = 2;
...
function template3() {
    const nama = document.getElementById("name").value ;
    btnList[templateSelect - 1].classList.remove('type-selected');
    btnList[2].classList.add('type-selected');
    templateSelect = 3;
...
function template4 (){
    const nama = document.getElementById("name").value ;
    btnList[templateSelect - 1].classList.remove('type-selected');
    btnList[3].classList.add('type-selected');
    templateSelect = 4;
...
getDefault();
function getDefault() {
  btnList[templateSelect - 1].classList.add('type-selected');
}
